...
unlocked to sign the DiceCOIN-Qt.app bundle.
...
allowing somebody to distribute a DiceCOIN-Qt.app or dicecoin-qt-setup.exe with a valid
...
that the dicecoin-qt.exe file inside the installer had not been tampered with.
